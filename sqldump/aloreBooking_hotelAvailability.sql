...
CREATE TABLE `hotelAvailability` (
  `availablerooms` varchar(255) DEFAULT NULL,
  `hotelId` int(11) DEFAULT NULL,
  `haId` int(11) NOT NULL AUTO_INCREMENT,
  `availableDate` date DEFAULT NULL,
  PRIMARY KEY (`haId`),
  KEY `hotelId` (`hotelId`),
  CONSTRAINT `hotelAvailability_ibfk_1` FOREIGN KEY (`hotelId`) REFERENCES `hotel` (`hotelId`)
...
INSERT INTO `hotelAvailability` VALUES ('40',5,1,'2020-04-28');
